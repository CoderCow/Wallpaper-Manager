...
namespace WallpaperManager.ViewModels {
  ...
  public class WallpaperVM: IWeakEventListener, IDataErrorInfo, INotifyPropertyChanged {
    ...
    /// <summary>
    ///   Gets the wrapped <see cref="WallpaperManager.Models.Wallpaper" /> instance.
    /// </summary>
    /// <value>
    ///   The wrapped <see cref="WallpaperManager.Models.Wallpaper" /> instance.
    /// </value>
    ...
    /// <summary>
    ///   Gets or sets a value indicating whether the wrapped <see cref="WallpaperManager.Models.Wallpaper" /> 
    ///   instance is actually applied on the users Desktop.
    /// </summary>
    /// <value>
    ///   <c>true</c> if the wrapped <see cref="WallpaperManager.Models.Wallpaper" /> instance is actually applied 
