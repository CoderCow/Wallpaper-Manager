...
namespace WallpaperManager.ApplicationInterface {
  ...
  public class ApplicationVM: INotifyPropertyChanged {
    ...
    /// <summary>
    ///   Gets the <see cref="WallpaperManager.ApplicationInterface.WallpaperCategoryCollectionVM" /> instance.
    /// </summary>
    /// <value>
    ///   The <see cref="WallpaperManager.ApplicationInterface.WallpaperCategoryCollectionVM" /> instance.
    /// </value>
    /// <seealso cref="WallpaperManager.ApplicationInterface.WallpaperCategoryCollectionVM">WallpaperCategoryCollectionVM Class</seealso>
    ...
    /// <summary>
    ///   Gets the the <see cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM" /> instance providing an interface to control the cycling 
    ///   of wallpapers.
    /// </summary>
    /// <value>
    ///   The the <see cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM" /> instance providing an interface to control the cycling of 
    ///   wallpapers.
    /// </value>
    /// <seealso cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM">WallpaperChangerVM Class</seealso>
    ...
    ///   The the <see cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM" /> instance providing an interface to 
