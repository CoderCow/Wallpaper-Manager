...
namespace WallpaperManager.Presentation {
  ...
  public partial class Application: System.Windows.Application, INotifyPropertyChanged, IDisposable {
    ...
    /// <summary>
    ///   Handles the <see cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM.UnhandledCommandException" /> event of a 
    ///   <see cref="WallpaperManager.ApplicationInterface.WallpaperChangerVM" /> instance and handles the thrown exception if 
    ///   possible.
    /// </summary>
    /// <commondoc select='All/Methods/EventHandlers[@Params="Object,+EventArgs"]/*' />
